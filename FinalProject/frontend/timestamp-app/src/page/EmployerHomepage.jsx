        ...
        >
            <section className='mt-10'>
                <div className="flex items-center mb-6">
                    <h1 className="px-9 text-2xl w-1/2">
                        {user
                                            ...
                                            <td class="px-2 py-4 flex justify-center">
                                                <div className="flex gap-2">
                                                    ...
                                                    <burron
                                                        ...
                                                        className="block w-[100px] cursor-pointer select-none rounded-lg bg-pink-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                                    >
                                                        Remove
                                                    </burron>
                                                </div>
                                            ...
                                            <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                                <div className="flex gap-2">
                                                    ...
                                                    <burron
                                                        ...
                                                        className="block cursor-pointer w-full select-none rounded-lg bg-pink-500 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                                                    >
                                                        Remove
                                                    </burron>
                                                </div>
